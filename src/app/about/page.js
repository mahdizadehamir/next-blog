...
function About() {
  return (
    <main class="container mx-auto px-4 py-8">
      <section class="bg-slate-900 p-6 rounded-lg shadow-lg">
        <h2 class="text-2xl font-semibold mb-4">معرفی وبلاگ</h2>
        <p class="mb-4">
        ...
        <h2 class="text-2xl font-semibold mb-4">چرا وبلاگ ما؟</h2>
        ...
        <h2 class="text-2xl font-semibold mb-4">اهداف ما</h2>
        <p class="mb-4">
        ...
        <h2 class="text-2xl font-semibold mb-4">تیم ما</h2>
        <p>
